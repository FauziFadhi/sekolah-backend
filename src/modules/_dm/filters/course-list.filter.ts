...
import { ListCourseQuery } from '../requests/course.request';

export const CourseListFilter = createParamDecorator(
...
class filter extends BaseFilter {
  ...
  constructor(query: ListCourseQuery) {
    super(query)
  ...
  search() {
    this.where = {
      ...this.where,
      [Op.or]: [
        seq.where(seq.fn('lower', seq.col('DmCourse.name')), { [Op.like]: `%${this.query.search}%` }),
      ]
    }
    return this
